CREATE TABLE "BAND" (
	"band_id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "BAND_band_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"band_number" varchar(20) NOT NULL,
	"technology" varchar(20) NOT NULL,
	"frequency_range" varchar(100) NOT NULL,
	"band_class" varchar(50)
);
--> statement-breakpoint
CREATE TABLE "COMBO" (
	"combo_id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "COMBO_combo_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
--> statement-breakpoint
ALTER TABLE "COMBO_BAND" ADD CONSTRAINT "COMBO_BAND_combo_id_COMBO_combo_id_fk" FOREIGN KEY ("combo_id") REFERENCES "public"."COMBO"("combo_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "COMBO_BAND" ADD CONSTRAINT "COMBO_BAND_band_id_BAND_band_id_fk" FOREIGN KEY ("band_id") REFERENCES "public"."BAND"("band_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "DEVICE_SOFTWARE_BAND" ADD CONSTRAINT "DEVICE_SOFTWARE_BAND_band_id_BAND_band_id_fk" FOREIGN KEY ("band_id") REFERENCES "public"."BAND"("band_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "DEVICE_SOFTWARE_COMBO" ADD CONSTRAINT "DEVICE_SOFTWARE_COMBO_combo_id_COMBO_combo_id_fk" FOREIGN KEY ("combo_id") REFERENCES "public"."COMBO"("combo_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "DEVICE_SOFTWARE_PROVIDER_FEATURE" ADD CONSTRAINT "DEVICE_SOFTWARE_PROVIDER_FEATURE_provider_id_PROVIDER_provider_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."PROVIDER"("provider_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "PROVIDER_DEVICE_SOFTWARE_BAND" ADD CONSTRAINT "PROVIDER_DEVICE_SOFTWARE_BAND_provider_id_PROVIDER_provider_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."PROVIDER"("provider_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "PROVIDER_DEVICE_SOFTWARE_BAND" ADD CONSTRAINT "PROVIDER_DEVICE_SOFTWARE_BAND_band_id_BAND_band_id_fk" FOREIGN KEY ("band_id") REFERENCES "public"."BAND"("band_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "PROVIDER_DEVICE_SOFTWARE_COMBO" ADD CONSTRAINT "PROVIDER_DEVICE_SOFTWARE_COMBO_provider_id_PROVIDER_provider_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."PROVIDER"("provider_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
